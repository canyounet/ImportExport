...
namespace EStoreTemplatev21.Models
{
    public partial class MyeStoreContext : DbContext
    {
        ...
        // Unable to generate entity type for table 'dbo.CauHinh'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.NguoiDung'. Please see the warning messages.
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=.; Database=MyeStore; Integrated Security=true;");
            }
        }
